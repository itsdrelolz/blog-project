...
router.post('/posts', postValidators.createPost, async (req: Request, res: Response, next: NextFunction) => {
    try { 
...
router.put('/posts/:id', postValidators.updatePost, async(req: Request, res: Response, next: NextFunction) => { 
    try { 
